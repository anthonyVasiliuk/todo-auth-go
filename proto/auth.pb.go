...
const file_proto_auth_proto_rawDesc = "" +
	...
	"\x04role\x18\x02 \x01(\tR\x04role2G\n" +
	"\vAuthService\x128\n" +
	"\vVerifyToken\x12\x12.auth.TokenRequest\x1a\x13.auth.TokenResponse\"\x00B\tZ\a./protob\x06proto3"
...
var file_proto_auth_proto_depIdxs = []int32{
	...
	1, // 1: auth.AuthService.VerifyToken:output_type -> auth.TokenResponse
